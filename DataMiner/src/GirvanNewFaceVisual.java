...
public class GirvanNewFaceVisual extends JApplet {
...
//	Factory<Graph<Number,Number>> graphFactory;
    ...
    public static void main(String[] args) throws IOException {
        ...
        GirvanNewFaceVisual cd = new GirvanNewFaceVisual();
        cd.start();
    ...
    public void start() {
        ...
        InputStream is = GirvanNewFaceVisual.class.getResourceAsStream("datasets/facebookProfileData.net");
    ...
    private void setUpView(BufferedReader br) throws IOException {
        ...
        final JToggleButton groupVertices = new JToggleButton("Grupiraj čvorove");
        ...
        final String COMMANDSTRING = "Broj eliminiranih rubova: ";
